package appSource
{
	...
	public class AppTextArea extends TextArea
	{
		...
		{
			if(AppViewManager.controlsAdded.contains(this))
			{
				var thisItemIndex:int = AppViewManager.controlsAdded.getItemIndex(this);
				AppViewManager.controlsAdded.removeItemAt(thisItemIndex);
				this.visible = false;
			}
		}

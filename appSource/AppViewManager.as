package appSource
{
	...
	public class AppViewManager
	{
		...
		public static var selectedControl:UIComponent;
		...
		public static function getResult():String
		{
			...
			/* generate mashup description information*/
			resultString += 'var config_items = [\n';
			var metaConfigPanel:Canvas = (controlsAdded.getItemAt(0) as UIComponent).parentApplication["appViewer"]["metaConfigPanel"];
			var appName:String = metaConfigPanel["appName"].text;
			var shortDesc:String = metaConfigPanel["shortDesc"].text;
			var longDesc:String = metaConfigPanel["longDesc"].text;
			resultString += '{\n';
			resultString += 'name:"'+appName+'",\n';
			resultString += 'shortDesc: "'+shortDesc+'",\n';
			resultString += 'longDesc: "'+longDesc+'",\n';
			resultString += '},\n';
			resultString += '];\n';
			
			
			/* generate resultPageConfig information*/
